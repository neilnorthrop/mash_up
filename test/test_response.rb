...
class TestResponse < MiniTest::Test
  ...
  def test_requested_file_joins_a_resource
    assert_equal Response.clean_path('/index.html'), './views/index.html'
  end

  def test_requested_file_removes_double_periods_from_resource_but_keeps_directories
    assert_equal Response.clean_path('/../../../hello/index.html'), './views/hello/index.html'
  end

  def test_requested_file_removes_double_periods_from_resource
    assert_equal Response.clean_path('/../../hello/../index.html'), './views/index.html'
  end
end